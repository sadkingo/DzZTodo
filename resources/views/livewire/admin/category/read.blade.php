                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('position')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'position') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'position') fa-sort-amount-up ml-2 @endif'></i> {{ __('Position') }} </th>
